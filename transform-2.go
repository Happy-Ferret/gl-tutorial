...
func main() {
	var (
		...
		transLocation     gl.UniformLocation
		vao               gl.VertexArray
		trans             glm.Mat4
		startTime         time.Time
	...
	transLocation = program.GetUniformLocation("trans")
	...
	for !window.ShouldClose() {
		...
		trans = glm.HomogRotate3DZ(math.Pi * float32(diffTime.Seconds()))
		transLocation.UniformMatrix4fv(false, trans)
